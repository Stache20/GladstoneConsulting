...
function Service() {
  return (
    <div id="Service" class="box ">
      <div class="row">
        <ServiceDisplay
          image={require("../images/pexels-cottonbro-studio-4098228.jpg")}
        />
        <ServicesContent
...
This service is available in both Vancouver and Toronto. 
 "
      ...
      <div class="row">
        <ServicesContent
          header="BCBA Supervision"
          text="Marni offers extremely comprehensive and supportive supervision for folks looking to acquire their supervision hours. This is a great option for those looking to get supervision in the forensic field.

Marni has the ability to take on trainees and supervisees across Canada for this. However, priority will be given to those living in Vancouver and Toronto. "
          link="/Supervision"
        />

        <ServiceDisplay
          image={require("../images/pexels-cottonbro-studio-4098369.jpg")}
        />
      </div>
      <div class="row">
        <ServiceDisplay
          image={require("../images/pexels-lisa-fotios-1655329.jpg")}
        />
        <ServicesContent
          header="BCBA Exam Tutoring"
          text="Marni worked extremely hard to finish her masters in Special Education and ABA with an overall average of 99%. She was also able to pass her BCBA exam on the first try and would love to help other aspiring BCBAs feel confident and full of knowledge going into their exam or courses so she offers comprehensive tutoring and study plans. For virtual tutoring Marni can take on clients from anywhere in the world.
 "
        />
      </div>
      <div class="row">
        <ServicesContent
          header="Social Skills Groups"
          text="Marni and some of her colleagues are offering a comprehensive social skills program for youth requiring additional support in social and relational skills.
...
Currently, this service is only being offered in Vancouver.
 "
      ...
      <div class="row">
        ...
        <ServicesContent
          header="Consultation"
          text="Marni is available to consult on cases as part of an interdisciplinary team. She has experience working with folks of all ages, levels of need and severity of behaviours. For consultative services, Marni will meet with the team and provide suggestions and on-going support. 
...
Marni has the ability to take on clients across Canada for this. However, priority will be given to those living in Vancouver and Toronto.
 "
      ...
      <div class="row">
        <ServicesContent
          header="Functional Living Skills Training"
          text="Marni has lots of experience teaching independence and functional living skills to children, youth and adults. If you're looking for specialized functional living skills programming to improve independence such as: making the bed, doing laundry, washing dishes, ordering at restaurants, etc. this is a great service!
 "
        />
      ...
      <div class="row">
        ...
        <ServicesContent
          ...
          text="Marni has the ability to take on a limited number of direct service clients in both Vancouver and Toronto. This includes but is not limited to: Functional Behaviour Assessment or Curriculum based assessment, Behaviour Support Plan development, caregiver training, IT/BI training, and ongoing supervision of programming.
